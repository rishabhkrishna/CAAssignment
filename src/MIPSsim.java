...
public class MIPSsim {
	...
	public boolean simulation() {
		...
		case "SW":
			...
			nextAddrLoc=impSW(decodedInstruction);
			break;
		case "LW":
			System.out.println("LW");
			nextAddrLoc=impLW(decodedInstruction);
			break;
		case "ADD":
		...
		System.out.println(processingLocation.get(simulationKey));
		return true;
	}
	...
	//SW R5, 216(R6)
	public int impSW(String decodedInstruction) {
		int nextAddr=0;
	...
	public int impLW(String decodedInstruction) {
		int nextAddr=0;
